...
import "github.com/Univ-Wyo-Education/Blockchain-4010-Fall-2018/Assignments/A-04/block"
...
// the resulting hash.
func MineBlock(bk *block.BlockType) {
	// Pseudo-Code
	//
	...
	InstructorImplementationMineBlock(bk)
}
